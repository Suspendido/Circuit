        ...
        this.helpFormatter = (sender, container) -> {
            ...
            if (!(sender instanceof Player)) {
                ...
                for (DrinkCommand c : commands) {
                    sender.sendMessage(CC.translate(" &7* &9/" + container.getName() + (!c.getName().isEmpty() ? " &9" + c.getName() : "") + " &8" + c.getMostApplicableUsage() + "&8 &8(&7&o" + c.getDescription() + "&8)"));
                }
            ...
            for (DrinkCommand c : commands) {
                ...
                TextComponent msg = new TextComponent(net.md_5.bungee.api.ChatColor.translateAlternateColorCodes('&',
                        " &7* &9/" + container.getName() + (!c.getName().isEmpty() || !c.getName().equalsIgnoreCase("") ? " &9" + c.getName() + " &8" + c.getMostApplicableUsage() + "&8 &8(&7&o" + c.getDescription() + "&8)" : " &8(&7&o" + c.getDescription() + "&8)") ));
